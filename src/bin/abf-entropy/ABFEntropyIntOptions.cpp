...
#include "ABFEntropyIntOptions.hpp"

//==============================================================================
//------------------------------------------------------------------------------
//==============================================================================

CABFEntropyIntOptions::CABFEntropyIntOptions(void)
{
...
int CABFEntropyIntOptions::CheckOptions(void)
{
    if(GetOptLimit() < 0) {
...
int CABFEntropyIntOptions::CheckArguments(void)
{
...
int CABFEntropyIntOptions::FinalizeOptions(void)
{
    bool ret_opt = false;
