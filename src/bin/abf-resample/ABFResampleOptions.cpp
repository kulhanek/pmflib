...
CABFResampleOptions::CABFResampleOptions(void)
{
...
int CABFResampleOptions::CheckOptions(void)
{
    if(GetOptLimit() < 0) {
...
int CABFResampleOptions::CheckArguments(void)
{
...
int CABFResampleOptions::FinalizeOptions(void)
{
    bool ret_opt = false;
