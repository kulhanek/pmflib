#ifndef ABPSampOptionsH
#define ABPSampOptionsH
// =============================================================================
...
class CABPSampOptions : public CSimpleOptions {
public:
    // constructor - tune option setup
    CABPSampOptions(void);
...
// program name and description -----------------------------------------------
    ...
    CSO_PROG_DESC_BEGIN
    "It prints number of samples accumulated during the ABP calculation."
    CSO_PROG_DESC_END
...
// description of arguments ---------------------------------------------------
    CSO_MAP_ARG(CSmallString,                   /* argument type */
                ...
                "Name of file containing the ABP accumulator. If the name is '-' then the accumulator is read from the standard input.")   /* argument description */
    //----------------------------------------------------------------------
    CSO_MAP_ARG(CSmallString,                   /* argument type */
...
// description of options ---------------------------------------------------
    ...
    CSO_MAP_OPT(CSmallString,                           /* option type */
                ...
                "fe",                      /* long option name */
                "FORMAT",                           /* parametr name */
                "Output FORMAT, which will be used to print samples.")   /* option description */
    //----------------------------------------------------------------------
    CSO_MAP_OPT(bool,                           /* option type */
                Verbose,                        /* option name */
                false,                          /* default value */
