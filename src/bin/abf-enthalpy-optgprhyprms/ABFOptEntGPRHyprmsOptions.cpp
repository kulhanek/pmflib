...
#include "ABFOptEntGPRHyprmsOptions.hpp"

//==============================================================================
//------------------------------------------------------------------------------
//==============================================================================

CABFOptEntGPRHyprmsOptions::CABFOptEntGPRHyprmsOptions(void)
{
...
int CABFOptEntGPRHyprmsOptions::CheckOptions(void)
{
...
int CABFOptEntGPRHyprmsOptions::CheckArguments(void)
{
...
int CABFOptEntGPRHyprmsOptions::FinalizeOptions(void)
{
    bool ret_opt = false;
