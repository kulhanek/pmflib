...
CABFEnthalpyOptGPRHyprmsOptions::CABFEnthalpyOptGPRHyprmsOptions(void)
{
...
int CABFEnthalpyOptGPRHyprmsOptions::CheckOptions(void)
{
...
int CABFEnthalpyOptGPRHyprmsOptions::CheckArguments(void)
{
...
int CABFEnthalpyOptGPRHyprmsOptions::FinalizeOptions(void)
{
    bool ret_opt = false;
