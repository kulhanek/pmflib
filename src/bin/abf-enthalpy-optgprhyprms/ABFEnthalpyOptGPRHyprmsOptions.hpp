...
class CABFEnthalpyOptGPRHyprmsOptions : public CSimpleOptions {
public:
    // constructor - tune option setup
    CABFEnthalpyOptGPRHyprmsOptions(void);
...
// program name and description -----------------------------------------------
    ...
    CSO_PROG_DESC_BEGIN
    "The program finds optimal GPR hyperparameters, which maximize logarithm of marginal likelihood for enthalpy. "
