#ifndef ABFOptEntGPRHyprmsOptionsH
#define ABFOptEntGPRHyprmsOptionsH
// =============================================================================
...
class CABFOptEntGPRHyprmsOptions : public CSimpleOptions {
public:
    // constructor - tune option setup
    CABFOptEntGPRHyprmsOptions(void);

// program name and description -----------------------------------------------
    CSO_PROG_NAME_BEGIN
    "abf-enthalpy-optgprhyprms"
    CSO_PROG_NAME_END

    CSO_PROG_DESC_BEGIN
    "abf-enthalpy-optgprhyprms finds optimal GPR hyperparameters, which maximize logarithm of marginal likelihood for enthalpy. "
