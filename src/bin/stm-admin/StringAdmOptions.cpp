...
CStringAdmOptions::CStringAdmOptions(void)
{
...
int CStringAdmOptions::CheckOptions(void)
{
...
int CStringAdmOptions::FinalizeOptions(void)
{
    bool ret_opt = false;
...
int CStringAdmOptions::CheckArguments(void)
{
    CActionRequest server_desc;
    server_desc.SetProtocolName("stm");
    ...
    if((server_desc.GetAction() != "info") &&
            ...
            (server_desc.GetAction() != "terminate") &&
            (server_desc.GetAction() != "errors") &&
            (server_desc.GetAction() != "get") &&
            (server_desc.GetAction() != "release") &&
