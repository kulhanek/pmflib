...
program pmf_path_reconstruct
    ...
    call pmf_utils_header('Path reconstruction')
    ...
    ! save paths ---------------------------------------------------------------
    write(PMF_OUT,*)
    call pmf_utils_heading(PMF_OUT,'Saving paths',':')
    write(PMF_OUT,*)
    ...
    do i=1,NumOfPaths
        call pmf_paths_write_path(PDRV_OUT,PathList(i)%path)
    end do

    close(PDRV_OUT)

    call pmf_utils_footer('Path reconstruction')

100 format('Paths are read from file : ',A)
110 format('Paths are written to file : ',A)
contains
...
10 format('    pmf-path-reconstruct <input> <output>')

end subroutine print_usage

!===============================================================================

end program pmf_path_reconstruct
