...
#include "ABFEnergyOptGPRHyprmsOptions.hpp"

//==============================================================================
//------------------------------------------------------------------------------
//==============================================================================

CABFEnergyOptGPRHyprmsOptions::CABFEnergyOptGPRHyprmsOptions(void)
{
...
int CABFEnergyOptGPRHyprmsOptions::CheckOptions(void)
{
...
int CABFEnergyOptGPRHyprmsOptions::CheckArguments(void)
{
...
int CABFEnergyOptGPRHyprmsOptions::FinalizeOptions(void)
{
    bool ret_opt = false;
