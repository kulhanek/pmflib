#ifndef MTDSrvOptionsH
#define MTDSrvOptionsH
// ===============================================================================
...
class CMTDSrvOptions : public CSimpleOptions {
public:
...
// program name and description -----------------------------------------------
    ...
    CSO_PROG_DESC_BEGIN
    "It is the server for the multiple walkers extension of the metadynamics method."
    CSO_PROG_DESC_END
