...
CABPAdmOptions::CABPAdmOptions(void)
{
...
int CABPAdmOptions::CheckOptions(void)
{
...
int CABPAdmOptions::FinalizeOptions(void)
{
    bool ret_opt = false;
...
int CABPAdmOptions::CheckArguments(void)
{
    CActionRequest server_desc;
    server_desc.SetProtocolName("abp");
