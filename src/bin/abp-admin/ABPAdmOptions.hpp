#ifndef ABPAdmOptionsH
#define ABPAdmOptionsH
// ===============================================================================
...
class CABPAdmOptions : public CSimpleOptions {
public:
...
// program name and description -----------------------------------------------
    ...
    CSO_PROG_DESC_BEGIN
    "The utility that controls the behaviour and state of the server implementing the multiple walkers extension of the ABP method."
    CSO_PROG_DESC_END
...
// description of arguments ---------------------------------------------------
    CSO_MAP_ARG(CSmallString,                   /* argument type */
                ...
                "abp://server[:port]/command",                        /* parametr name */
                ...
                "flush          = save the accumulated ABP data on the server side\n"
                "get?file=NAME  = get the accumulated ABP data and saves them locally to the NAME file (the default name is _abpserver.rst)\n"
