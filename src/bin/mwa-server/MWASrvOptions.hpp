#ifndef MWASrvOptionsH
#define MWASrvOptionsH
// =============================================================================
...
class CMWASrvOptions : public CSimpleOptions {
public:
...
// program name and description -----------------------------------------------
    ...
    CSO_PROG_DESC_BEGIN
    "<b>mwa-server</b> is the server for the multiple walkers extension in PMFLib."
    CSO_PROG_DESC_END
