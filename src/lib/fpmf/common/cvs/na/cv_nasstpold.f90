...
!-------------------------------------------------------------------------------
!    Copyright (C) 2020-21 Petr Kulhanek, kulhanek@chemi.muni.cz
!
...
!===============================================================================
! Subroutine:  load_nasstpold
!===============================================================================

subroutine load_nasstpold(cv_item,prm_fin)
...
end subroutine load_nasstpold

!===============================================================================
! Subroutine:  calculate_nasstpold
!===============================================================================

subroutine calculate_nasstpold(cv_item,x,ctx)
    ...
    call calculate_nasstpold_getbp1(cv_item,x,ua,oa)
    call calculate_nasstpold_getbp2(cv_item,x,ub,ob)

    call calculate_nasstpold_value(cv_item,ctx,ua,oa,ub,ob,a_ua,a_oa,a_ub,a_ob)

    call calculate_nasstpold_getbp1_der(cv_item,x,ctx,a_ua,a_oa)
    call calculate_nasstpold_getbp2_der(cv_item,x,ctx,a_ub,a_ob)

end subroutine calculate_nasstpold

!===============================================================================
! Subroutine:  calculate_nasstpold_value_num
!===============================================================================

subroutine calculate_nasstpold_value_num(cv_item,ctx,ua,oa,ub,ob,a_ua,a_oa,a_ub,a_ob)
    ...
    do i=1,3
        do j=1,3
            l_ua = ua
            l_ua(i,j) = l_ua(i,j) - d
            call calculate_nasstpold_value(cv_item,ctx,l_ua,l_oa,l_ub,l_ob,l_a_ua,l_a_oa,l_a_ub,l_a_ob)
...
end subroutine calculate_nasstpold_value_num

!===============================================================================
! Subroutine:  calculate_nasstpold_value
!===============================================================================

subroutine calculate_nasstpold_value(cv_item,ctx,ua,oa,ub,ob,a_ua,a_oa,a_ub,a_ob)
...
! vector between origins
    ...
    select case(cv_item%lst_par)
        ...
        case(6)
            ...
            ctx%CVsValues(cv_item%idx) = sign(1.0d0,asc)*acos(arg)
        case default
            call pmf_utils_exit(PMF_OUT,1,'Unrecognized value for parameter option in calculate_nasstpold!')
    end select
...
end subroutine calculate_nasstpold_value

!===============================================================================
! Subroutine:  calculate_nasstpold_getbp1
!===============================================================================

subroutine calculate_nasstpold_getbp1(cv_item,x,mst,morg)
    use pmf_dat
    use pmf_pbc
    use pmf_utils
...
end subroutine calculate_nasstpold_getbp1

!===============================================================================
! Subroutine:  calculate_nasstpold_getbp1_der
!===============================================================================

subroutine calculate_nasstpold_getbp1_der(cv_item,x,ctx,a_mst,a_morg)
    use pmf_dat
    use pmf_pbc
    use pmf_utils
...
end subroutine calculate_nasstpold_getbp1_der

!===============================================================================
! Subroutine:  calculate_nasstpold_getbp2
!===============================================================================

subroutine calculate_nasstpold_getbp2(cv_item,x,mst,morg)
    use pmf_dat
    use pmf_pbc
    use pmf_utils
...
end subroutine calculate_nasstpold_getbp2

!===============================================================================

!===============================================================================
! Subroutine:  calculate_nasstpold_getbp2_der
!===============================================================================

subroutine calculate_nasstpold_getbp2_der(cv_item,x,ctx,a_mst,a_morg)
    use pmf_dat
    use pmf_pbc
    use pmf_utils
...
end subroutine calculate_nasstpold_getbp2_der

end module cv_nasstpold
