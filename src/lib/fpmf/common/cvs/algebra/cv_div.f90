...
type, extends(CVType) :: CVTypeDIV

    integer :: left_cv
    integer :: right_cv

    contains
        procedure :: load_cv        => load_div
        procedure :: calculate_cv   => calculate_div
end type CVTypeDIV
...
subroutine load_div(cv_item,prm_fin)
...
!===============================================================================
! Subroutine:  calculate_div
!===============================================================================

subroutine calculate_div(cv_item,x,ctx)
