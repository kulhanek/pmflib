...
type, extends(CVType) :: CVTypeSUB

    integer :: left_cv
    integer :: right_cv

    contains
        procedure :: load_cv        => load_sub
        procedure :: calculate_cv   => calculate_sub
end type CVTypeSUB
...
subroutine load_sub(cv_item,prm_fin)
...
end subroutine load_sub

!===============================================================================
! Subroutine:  calculate_sub
!===============================================================================

subroutine calculate_sub(cv_item,x,ctx)
