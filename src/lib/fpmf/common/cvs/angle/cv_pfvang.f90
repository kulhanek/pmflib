...
type, extends(CVType) :: CVTypePFVANG
    ...
    contains
        procedure :: load_cv        => load_pfvang
        procedure :: calculate_cv   => calculate_pfvang
end type CVTypePFVANG
...
!===============================================================================
! Subroutine:  load_pfvang
!===============================================================================

subroutine load_pfvang(cv_item,prm_fin)
...
end subroutine load_pfvang

!===============================================================================
! Subroutine:  calculate_pfvang
!===============================================================================

subroutine calculate_pfvang(cv_item,x,ctx)
...
!        call pmf_utils_exit(PMF_OUT,1,'totmass1 is zero in calculate_pfvang!')
!    end if
!    d1(:) = d1(:) / totmass1
...
!    if( info .ne. 0 ) then
!        call pmf_utils_exit(PMF_OUT,1,'Unable to diagonalize matrix in calculate_pfvang (plane A)!')
!    end if
...
end subroutine calculate_pfvang

!===============================================================================

end module cv_pfvang
