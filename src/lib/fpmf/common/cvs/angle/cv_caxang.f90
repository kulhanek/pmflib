...
! cos(angle) between two principal axes - AXANG
...
type, extends(CVType) :: CVTypeCAXANG
    ...
    contains
        procedure :: load_cv        => load_caxang
        procedure :: calculate_cv   => calculate_caxang
end type CVTypeCAXANG
...
!===============================================================================
! Subroutine:  load_caxang
!===============================================================================

subroutine load_caxang(cv_item,prm_fin)

    use prmfile
    use pmf_utils

    implicit none
    class(CVTypeCAXANG)                 :: cv_item
...
end subroutine load_caxang

!===============================================================================
! Subroutine:  calculate_caxang
!===============================================================================

subroutine calculate_caxang(cv_item,x,ctx)
    ...
    if( totmass1 .le. 0 ) then
        call pmf_utils_exit(PMF_OUT,1,'totmass1 is zero in calculate_caxang!')
    end if
    ...
    if( totmass2 .le. 0 ) then
        call pmf_utils_exit(PMF_OUT,1,'totmass2 is zero in calculate_caxang!')
    end if
    ...
    if( info .ne. 0 ) then
    call pmf_utils_exit(PMF_OUT,1,'Unable to diagonalize T1 matrix in calculate_caxang!')
    end if
    ...
    if( info .ne. 0 ) then
        call pmf_utils_exit(PMF_OUT,1,'Unable to diagonalize T2 matrix in calculate_caxang!')
    end if
...
end subroutine calculate_caxang

!===============================================================================

end module cv_caxang
