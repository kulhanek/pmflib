...
type, extends(CVType) :: CVTypeWORMPOS
    ...
    contains
        procedure :: load_cv        => load_wormpos
        procedure :: calculate_cv   => calculate_wormpos
end type CVTypeWORMPOS
...
!===============================================================================
! Subroutine:  load_wormpos
!===============================================================================

subroutine load_wormpos(cv_item,prm_fin)

    use prmfile
    use pmf_utils

    implicit none
    class(CVTypeWORMPOS)                 :: cv_item
...
end subroutine load_wormpos

!===============================================================================
! Subroutine:  calculate_wormpos
!===============================================================================

subroutine calculate_wormpos(cv_item,x,ctx)
    ...
    if( info .ne. 0 ) then
    call pmf_utils_exit(PMF_OUT,1,'Unable to diagonalize matrix in calculate_wormpos!')
    end if
...
end subroutine calculate_wormpos

!===============================================================================

end module cv_wormpos
