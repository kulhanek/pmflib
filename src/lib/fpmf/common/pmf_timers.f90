...
integer     :: PMFLIB_TOTAL_TIMER                       = -10
    integer     :: PMFLIB_TIMER                         = -20
        ...
        integer     :: PMFLIB_METHODS_TIMER             = -40
            ...
            integer     :: PMFLIB_TABF_TIMER            = -56
            integer     :: PMFLIB_USABF_TIMER           = -57
            ...
            integer     :: PMFLIB_SHKFRC_TIMER          = -85
            integer     :: PMFLIB_LNGFRC_TIMER          = -86
...
subroutine pmf_timers_init
 ...
 PMFLIB_TIMER           = add_timer(PMFLIB_TOTAL_TIMER,'PMFLib')
    ...
    PMFLIB_METHODS_TIMER          = add_timer(PMFLIB_TIMER,'Methods')
        ...
        PMFLIB_TABF_TIMER           = add_timer(PMFLIB_METHODS_TIMER,'Adaptive Biasing Force (testing)')
        PMFLIB_USABF_TIMER          = add_timer(PMFLIB_METHODS_TIMER,'Umbrella Sampling / Adaptive Biasing Force')
        ...
        PMFLIB_SHKFRC_TIMER         = add_timer(PMFLIB_METHODS_TIMER,'SHAKE Forces')
        PMFLIB_LNGFRC_TIMER         = add_timer(PMFLIB_METHODS_TIMER,'Langevin Forces')
