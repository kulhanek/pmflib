    ...
    integer     :: PMFLIB_TIMER                         = -20
        ...
        integer     :: PMFLIB_METHODS_TIMER             = -40
            integer     :: PMFLIB_ABF_TIMER             = -50
                integer     :: PMFLIB_ABF_KS_TIMER      = -54
            ...
            integer     :: PMFLIB_CST_TIMER             = -70
                ...
                integer     :: PMFLIB_CST_ICF_TIMER     = -74
                    integer     :: PMFLIB_CST_ICF_HESS_TIMER     = -75
                    integer     :: PMFLIB_CST_ICF_ICFP_TIMER     = -76
                    integer     :: PMFLIB_CST_ICF_ICFK_TIMER     = -77
...
subroutine pmf_timers_init
 ...
 PMFLIB_TIMER           = add_timer(PMFLIB_TOTAL_TIMER,'PMFLib')
    ...
    PMFLIB_METHODS_TIMER          = add_timer(PMFLIB_TIMER,'Methods')
        PMFLIB_ABF_TIMER            = add_timer(PMFLIB_METHODS_TIMER,'ABF - Adaptive Biasing Force')
            PMFLIB_ABF_KS_TIMER         = add_timer(PMFLIB_ABF_TIMER,'Kernel Smoother')
            PMFLIB_ABF_MWA_TIMER        = add_timer(PMFLIB_ABF_TIMER,'MWA')
        PMFLIB_ABP_TIMER            = add_timer(PMFLIB_METHODS_TIMER,'ABP - Adaptive Biasing Potential')
            PMFLIB_ABP_MWA_TIMER        = add_timer(PMFLIB_ABP_TIMER,'MWA')
        PMFLIB_MTD_TIMER            = add_timer(PMFLIB_METHODS_TIMER,'MTD - Metadynamics')
            PMFLIB_MTD_MWA_TIMER        = add_timer(PMFLIB_MTD_TIMER,'MWA')
        PMFLIB_STM_TIMER            = add_timer(PMFLIB_METHODS_TIMER,'STM - String Method')
            PMFLIB_STM_NET_TIMER        = add_timer(PMFLIB_STM_TIMER,'Network Communication')
        PMFLIB_CST_TIMER            = add_timer(PMFLIB_METHODS_TIMER,'CST - Constrained Dynamics')
            ...
            PMFLIB_CST_ICF_TIMER        = add_timer(PMFLIB_CST_TIMER,'ICF')
                PMFLIB_CST_ICF_HESS_TIMER    = add_timer(PMFLIB_CST_ICF_TIMER,'Hessians')
                PMFLIB_CST_ICF_ICFP_TIMER    = add_timer(PMFLIB_CST_ICF_TIMER,'ICFP')
