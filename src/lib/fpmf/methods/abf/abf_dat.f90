...
! ABF force - incremental part for ABF-server
    ...
    real(PMFDP),pointer    :: inc_micf(:,:)             ! accumulated mean ICF  - reverted indexing due to C/Fortran interoperability
    real(PMFDP),pointer    :: inc_m2icf(:,:)            ! accumulated M2 of ICF - reverted indexing due to C/Fortran interoperability
