#ifndef GHSIntegratorGPRcCH
#define GHSIntegratorGPRcCH
// =============================================================================
...
class PMF_PACKAGE CGHSIntegratorGPRcC : public CGPRHyprms {
public:
// constructor and destructor -------------------------------------------------
    CGHSIntegratorGPRcC(void);
    virtual ~CGHSIntegratorGPRcC(void);
...
typedef boost::shared_ptr<CGHSIntegratorGPRcC>    CGHSIntegratorGPRcCPtr;
