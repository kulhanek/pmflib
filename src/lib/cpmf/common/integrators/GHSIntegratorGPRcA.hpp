#ifndef AUSIntegratorGPRcAH
#define AUSIntegratorGPRcAH
// =============================================================================
...
class PMF_PACKAGE CAUSIntegratorGPRcA : public CGPREngine {
public:
// constructor and destructor -------------------------------------------------
    CAUSIntegratorGPRcA(void);
    virtual ~CAUSIntegratorGPRcA(void);
...
typedef boost::shared_ptr<CAUSIntegratorGPRcA>    CAUSIntegratorGPRcAPtr;
